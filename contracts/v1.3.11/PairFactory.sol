...
contract PairFactory is Initializable {
	...
	uint256 public MAX_FEE_NEW = 1337; // 13.37%
    ...
    function setFee(bool _stable, uint256 _fee) external {
        require(msg.sender == feeManager, "not fee manager");
        require(_fee <= MAX_FEE_NEW, "fee too high");
    ...
    function getFee(bool _stable) public view returns(uint256) {
    	/// This method was changed in v1.3.11
    ...
    /* PAST IMPLEMENTAION OF `getFee() FOR FUTURE REFERENCE
    function getFee(bool _stable) public view returns(uint256) {
    ...
    */
    ...
    function hotload() external {
    	require(msg.sender == feeManager, "Team MS Only!");
    	/// v1.3.11
    	MAX_FEE_NEW = 1337; // 13.37%
    }
}
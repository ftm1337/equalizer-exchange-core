...
contract Voter is Initializable {
    ...
    function claimFees(address[] memory _fees, address[][] memory _tokens, uint _tokenId) external {
        ...
        for (uint i = 0; i < _fees.length; i++) {
        	require(
        		...
        		string(
        			abi.encodePacked(
        				"Equalizer v1.3.7 : Fees Claim too early! Next claim time for NFT #",
        				toString(_tokenId),
        				" is at ",
            ...
            catch {require(false, "Equalizer v1.3.7 : Fees Claim expired! Please try again in the next epoch.");}
        }
    }
    ...
    /// Utils - dont touch storage : internal pure view
